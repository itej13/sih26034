...
export default function CapturePage() {
  ...
  const runInspection = async () => {
    ...
    try {
      ...
      // The UI branch deliberately uses the existing scan boundary. The extraction,
      // measurement and evaluation orchestration joins once their PRs have landed.
      ...
      const result = await fallbackResponse.json() as ScanResponse;
